Showcases (homework assighnment for Data Analytics Boorcamp) a basic understanding of SQL database creation (PostreSQL), tables handling, data engineering, using Python Pandas with SQL databases.
